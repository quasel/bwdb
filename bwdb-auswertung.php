...
// @todo:  $attr durchgängi nutzen nicht mla aus dem Request und mal so möglich?
    ...
    <table>
        ...
        <tr>
            <td>
                <a href="<?php echo add_query_arg(array('show' => 'schnitt', 'sex' => '0', 'ssn_id' => $attr['ssn_id']), $base); ?>">Damen</a>
            </td>
            <td>
                <a href="<?php echo add_query_arg(array('show' => 'schnitt', 'sex' => '1', 'ssn_id' => $attr['ssn_id']), $base); ?>">Herren</a>
            </td>
            <td>
                <a href="<?php echo add_query_arg(array('show' => 'klss_ssn', 'klss_id' => '1,2,3', 'ssn_id' => $attr['ssn_id']), $base); ?>">4er
                    Gesamt</a></td>
            <td>
                <a href="<?php echo add_query_arg(array('show' => 'klss_ssn', 'klss_id' => '1', 'ssn_id' => $attr['ssn_id']), $base); ?>">4er
                    Gruppe A</a></td>
            <td>
                <a href="<?php echo add_query_arg(array('show' => 'klss_ssn', 'klss_id' => '2', 'ssn_id' => $attr['ssn_id']), $base); ?>">4er
                    Gruppe B</a></td>
            <td>
                <a href="<?php echo add_query_arg(array('show' => 'klss_ssn', 'klss_id' => '3', 'ssn_id' => $attr['ssn_id']), $base); ?>">4er
                    Gruppe C</a></td>
            <td>
                <a href="<?php echo add_query_arg(array('show' => 'klss_ssn', 'klss_id' => '4', 'ssn_id' => $attr['ssn_id']), $base); ?>">Damen-Doppel</a>
            </td>
            <td>
                <a href="<?php echo add_query_arg(array('show' => 'klss_ssn', 'klss_id' => '5', 'ssn_id' => $attr['ssn_id']), $base); ?>">Mix-Doppel</a>
            </td>
        </tr>
    </table>
        ...
        foreach ($schnittliste as $schnitt) {            // Schleife Ausgabe Schnittliste
            if ($schnitt->anzahl >= $allevent) {    // Filter, wie viele Spiele notwendig sind, um in der Schnittliste aufzuscheinen.  @todo -> gehört in die Abfrage !!!!!!
                ...
                <tr>
                    ...
                    <td align="left">    <?php
                        $link = $_SERVER['REQUEST']; //reset
                        $link = add_query_arg(array('show' => 'spieler',
                    ...
                    <td align="left"><?php
                        $link = $_SERVER['REQUEST']; //reset
                        $link = add_query_arg(array('show' => 'verein',
    ...
    <table class="bwdb">
        ...
        foreach ($data as $team) {
            ...
            <tr>
                ...
                <td align="left">    <?php
                    $link = $_SERVER['REQUEST']; //reset
                    $link = add_query_arg(array('show' => 'sktn_klss_ssn',
...
function bwdbShowVerein($attr)
{
    ...
    <table>
        ...
        <?php
        $sktn_vrn = bwdb_get_data(array('output' => 'sktn_klss_ssn', 'vrn_id' => $attr[vrn_id], 'ssn_id' => $attr[ssn_id]));
...
//		print_r($result);
    ...
    <select name="<?php echo $col ?>" size="1">
        ...
        foreach ($result as $val) {
            ...
            } else $name = esc_attr($val->$orderby);
